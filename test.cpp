            ...
            if (fds[i].revents & POLLIN && it == sockets.end())
            {
                ...
                if (bytesRead > 0)
                {
                    ...
                    if (Clients[clientSocket].getRequestBuffer().find("\r\n\r\n") != std::string::npos)
                    {
                        ...
                        // std::cout << "*********************\n";
                        // if (Clients[clientSocket].getRequestBuffer().find("\r\n\r\n") != std::string::npos)
                        // if (hasTwoEmptyLines(Clients[clientSocket].getRequestBuffer()))
                        // {
                        ...
                        //     std::cout << "==================before request : " << Clients[clientSocket].getRequestBuffer() << "\n";
                        ...
                        //         // std::cout << "********************chuncked********************\n";
                        //         // int pos = 0;
                        //         // pos = Clients[clientSocket].getRequestBuffer().find("\r\n\r\n", pos);
                        //         // std::cout << "SIZE = |" << Clients[clientSocket].getRequestBuffer().substr(pos + 4, 2).c_str() << "|\n";
                                
                        //         // int n;
                        //         // std::istringstream(Clients[clientSocket].getRequestBuffer().substr(pos + 4, 2).c_str()) >> std::hex >> n;
                        //         // std::cout << std::dec << "Parsing \"90\" as hex gives " << n << '\n';
                        //         // std::cout << "********************end chuncked********************\n"; 
                        //     std::cout << "============= request after : |" << Clients[clientSocket].getRequestBuffer() << "|\n";
